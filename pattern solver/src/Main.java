public class Main {
    ...
    public static int[][][] stringToContraints(String id){
    ...
    public static void main(String[] args)  {
        ...
        Puzzle puzzle = new Puzzle(constraints1[0], constraints1[1]);
